class Game {
  ...
  start() {
    ...
    lion = createSprite(width / 2 - 600, height - 200);
    lion.addAnimation("lion", lion_img);
    lion.scale = 1.5;

    horse = createSprite(width / 2 - 150, height - 150);
    horse.addAnimation("horse", horse_img);
    horse.scale = 1.5;

      monkey = createSprite(width / 2 - 150, height - 250);
    monkey.addAnimation("monkey", monkey_img);
    monkey.scale = 1.5;

    tiger = createSprite(width / 2 - 150, height - 100);
    ...
    var obstaclesPositions = [
      { x: width + 2 + 4000, y: height - 390, image: obstacle2Image },
      { x: width + 2 - 3500, y: height - 300, image: obstacle1Image },
      { x: width + 2 + 2500, y: height - 400, image: obstacle1Image },
      { x: width + 2 - 3000, y: height - 320, image: obstacle2Image },
      { x: width + 2 + 3900, y: height - 300, image: obstacle2Image },
      { x: width + 2 - 3500, y: height - 350, image: obstacle1Image },
      { x: width + 2 + 4000, y: height - 400, image: obstacle2Image },
      { x: width + 2 + 2000, y: height - 330, image: obstacle2Image },
      { x: width + 2 - 4500, y: height - 300, image: obstacle1Image },
      { x: width + 2 + 1200, y: height - 350, image: obstacle2Image },
      { x: width + 2 - 4000, y: height - 400, image: obstacle1Image },
      { x: width + 2 - 4500, y: height - 300, image: obstacle2Image },
      { x: width + 2 + 2200, y: height - 350, image: obstacle2Image },
      { x: width + 2 - 3000, y: height - 400, image: obstacle1Image },
      ];
  ...
  addSprites(spriteGroup, numberOfSprites, spriteImage, scale, positions = []) {
    for (var i = 0; i < numberOfSprites; i++) {
      ...
      if (positions.length > 0) {
        ...
        x = random(-width * 4.5, width - 400);
        y = random(height/2-150, height/2);
      }
